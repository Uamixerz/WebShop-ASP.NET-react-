...
namespace WebShop.Migrations
{
    ...
    [Migration("20230906152416_settings 0.1 Characteristics")]
    partial class settings01Characteristics
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryEntityCharacteristicsEntity", b =>
                {
                    ...
                    b.ToTable("CategoryEntityCharacteristicsEntity");
                });
            ...
            modelBuilder.Entity("CategoryEntityCharacteristicsEntity", b =>
                {
                    b.HasOne("WebShop.Data.Entities.CategoryEntity", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebShop.Data.Entities.Characteristics.CharacteristicsEntity", null)
                        .WithMany()
